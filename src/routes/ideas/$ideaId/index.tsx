...
function IdeaDetailsPage() {
  ...
  return <div className='p-4'>
    ...
    <Link to='/ideas/$ideaId/edit' className='inline-block text-sm bg-yellow-500 hover:bg-yellow-600 text-white mt-4 mr-2 px-4 py-2 rounded transition' params={{ ideaId }} >
      Edit
    </Link>

    <button
      onClick={handleDelete}
      className="text-sm bg-red-600 text-white mt-4 px-4 py-2 rounded transition hover:bg-red-700 disable:opacity:50" disabled={isPending}>
